...
//     try {
//       const response = await axios.get(`https://ai-v2-backend.onrender.com/logout`);
...
//   }
    ...
    async function handleSaveChat(){
        try {
            ...
            await axios.post(`https://ai-v2-backend.onrender.com/saveChat`, { allMessages, userIdToken: userIdToken });
    ...
    const handlePreviousChat = async () => {
        try {
            const response = await axios.get(`https://ai-v2-backend.onrender.com/getAllChats`);
                        ...
                        {allMessages.map((msg, index) => (
                            <div key={index} className='message'>
                                ...
                                <div className='details'>
                                    ...
                                    <h2 style={{marginTop: '0.5rem'}}>{msg.role === 'user' ? (`user`) : ('AI')}</h2>
